...
export const ShoppingCart = ({ isCheckoutPage, setIsOpen }) => {
  ...
  const handleOrder = async () => {
    ...
    try {
     const res = await axios.post(`https://js2-ecommerce-api.vercel.app/api/orders`, order);
     console.log(res)
  ...
  <div className="total-section">
    ...
    <div className="checkout-buttons">
      { isCheckoutPage
       ...
       : <button onClick={handleOrder} className="checkout-link"> Lägg till order! </button>
      }
    </div>
